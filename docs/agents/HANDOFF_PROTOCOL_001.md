...
*   **Rule 4: Exclusive Owner Approval.** No agent, including the Review Agent, is permitted to declare a milestone or screenshot "approved" or "successful". The Review Agent may only escalate to `[READY FOR HUMAN REVIEW]`. Final approval is the exclusive authority of the project owner (Jerry Can).
