-- ============================================================================
-- WORLD TRADE CENTER RECONSTRUCTION PROJECT: POSTGRESQL POSTGIS MIGRATION V1.0
-- Migration File: database/migrations/V1_0__create_world_model_schema.sql
-- Description: Executable DDL creating core World Model tables, ENUMs, and spatial indices
-- Author: Research Lead
-- Date: August 12, 2026
-- Governing Specification: docs/SCHEMA_DESIGN_SPECIFICATION_V1.md
-- ============================================================================
